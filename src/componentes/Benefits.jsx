...
const Benefits = () => {
  return (
    ...
    <div className='w-full flex flex-col p-4 my-4 rounded-lg shadow-xl border'>
            ...
            <h4 className='md:text-2xl text-xl font-bold text-center py-8'>Acesso ilimitado ao site e app</h4>
        ...
        <img className='w-40 mx-auto bg-white' src={Colunistas} alt="/" />
            <h4 className='md:text-2xl text-xl font-bold text-center py-8'>Os melhores colunistas do Brasil</h4>
        ...
        <img className='w-40 mx-auto bg-white' src={Clube} alt="/" />
            <h4 className='md:text-2xl text-xl font-bold text-center py-8'>Clube O Globo com descontos</h4>
