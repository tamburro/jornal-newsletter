    ...
    <div id='cards' className='w-full py-[10rem] px-10 bg-white'>
      ...
      <div className='max-w-[1240] mx-auto grid md:grid-cols-2'>
          ...
          <h4 className='md:text-2xl text-xl text-center py-8 uppercase'>Globo Digital</h4>
              ...
              <button className='bg-[#fff300] w-[200px] rounded-md my-1 mx-auto px-6 py-3 text-[#080250] uppercase shadow-sm hover:brightness-90'><a href="https://jornaldigital.oglobo.globo.com/">Assine agora</a></button>
