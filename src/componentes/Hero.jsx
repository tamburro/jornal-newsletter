...
const Hero = () => {
  return (
    <div id='hero' className='text-white hero'>
        ...
        <p className='text-xl font-bold text-white'>Apenas R$ <span className='text-3xl text-2xl'>1</span><sup>,90</sup>/mês nos 3 primeiros meses.<br/> <span className='font-normal'>Depois, pague R$24,90/mês.</span></p>
